...
this.driver.js = (function (D) {
  ...
  function V(e) {
    ...
    e.scrollIntoView({ behavior: !o || re(e) ? "auto" : "smooth", inline: "center", block: "center" });
  }
  function re(e) {
  ...
  function le(e, o, t, i) {
    ...
    (p = { x: w, y: r, width: v, height: s }), Y(p), b("__activeStagePosition", p);
  }
  function X(e) {
    if (!e) return;
    const o = e.getBoundingClientRect(),
  ...
  function ge(e, o) {
    const i = Date.now(),
      ...
      m = a(),
      g = l();
    !f && d && d(r ? void 0 : n, p, { config: m, state: g }), s && s(w ? void 0 : e, o, { config: m, state: g });
    const u = !f && v;
    let h = !1;
  ...
  function J(e, o) {
    ...
    (t.nextButton.innerHTML = r),
      ...
      p
        ? ((t.description.innerHTML = p), (t.description.style.display = "block"))
    ...
    g != null &&
      g.includes("next") &&
      ((t.nextButton.disabled = !0), t.nextButton.classList.add("driver-popover-btn-disabled")),
      g != null &&
        g.includes("previous") &&
        ((t.previousButton.disabled = !0), t.previousButton.classList.add("driver-popover-btn-disabled")),
      g != null &&
        g.includes("close") &&
        ((t.closeButton.disabled = !0), t.closeButton.classList.add("driver-popover-btn-disabled"));
    const u = t.wrapper;
    ...
    (u.className = `driver-popover ${P}`.trim()),
      G(
        ...
        (k) => {
          var M, R, I;
          const T = k.target,
            H = ((M = o.popover) == null ? void 0 : M.onNextClick) || a("onNextClick"),
            $ = ((R = o.popover) == null ? void 0 : R.onPrevClick) || a("onPrevClick"),
            B = ((I = o.popover) == null ? void 0 : I.onCloseClick) || a("onCloseClick");
  ...
  function ee(e, o) {
    ...
    return e === "start"
      ? Math.max(Math.min(t.top - p, window.innerHeight - i.realHeight - n.width), n.width)
      : e === "end"
      ? Math.max(
          Math.min(
  ...
  function te(e, o) {
    const { elementDimensions: t, popoverDimensions: i, popoverPadding: p, popoverArrowDimensions: n } = o;
    return e === "start"
      ? Math.max(Math.min(t.left - p, window.innerWidth - i.realWidth - n.width), n.width)
      : e === "end"
      ? Math.max(
          Math.min(
  ...
  function oe(e, o) {
    const t = l("popover");
    if (!t) return;
    const { align: i = "start", side: p = "left" } = (o == null ? void 0 : o.popover) || {},
      n = i,
    ...
    if (
      ...
      const C = Math.min(u, window.innerWidth - (r == null ? void 0 : r.realWidth) - v.width),
        y = ee(n, { elementDimensions: s, popoverDimensions: r, popoverPadding: w, popoverArrowDimensions: v });
      (t.wrapper.style.left = `${C}px`),
        (t.wrapper.style.top = `${y}px`),
        (t.wrapper.style.bottom = "auto"),
        (t.wrapper.style.right = "auto"),
      ...
      let y = te(n, { elementDimensions: s, popoverDimensions: r, popoverPadding: w, popoverArrowDimensions: v });
  ...
  function Ce(e, o, t) {
    ...
    let u = o,
      h = e;
    o === "top"
      ? (s + v <= 0 ? ((u = "right"), (h = "end")) : s + v - w <= 0 && ((u = "top"), (h = "start")),
        s >= r ? ((u = "left"), (h = "end")) : s + w >= r && ((u = "top"), (h = "end")))
      : o === "bottom"
      ? (s + v <= 0 ? ((u = "right"), (h = "start")) : s + v - w <= 0 && ((u = "bottom"), (h = "start")),
        s >= r ? ((u = "left"), (h = "start")) : s + w >= r && ((u = "bottom"), (h = "end")))
      : o === "left"
      ? (m + g <= 0 ? ((u = "bottom"), (h = "end")) : m + g - c <= 0 && ((u = "left"), (h = "start")),
        m >= d ? ((u = "top"), (h = "end")) : m + c >= d && ((u = "left"), (h = "end")))
      : o === "right" &&
        (m + g <= 0 ? ((u = "bottom"), (h = "start")) : m + g - c <= 0 && ((u = "right"), (h = "start")),
        m >= d ? ((u = "top"), (h = "start")) : m + c >= d && ((u = "right"), (h = "end"))),
      u
  ...
  function ke(e = {}) {
    ...
    function w() {
      l("isInitialized") ||
        (b("isInitialized", !0),
        document.body.classList.add("driver-active", a("animate") ? "driver-fade" : "driver-simple"),
        ye(),
        O("overlayClick", o),
        O("escapePress", o),
        O("arrowLeftPress", n),
    ...
    function r(s = 0) {
      ...
      const d = c[s],
        m = c[s + 1],
        g = c[s - 1],
        u = ((H = d.popover) == null ? void 0 : H.doneBtnText) || a("doneBtnText") || "Done",
        h = a("allowClose"),
        P =
          typeof (($ = d.popover) == null ? void 0 : $.showProgress) != "undefined"
            ? (B = d.popover) == null
              ? void 0
              : B.showProgress
            : a("showProgress"),
        L = (((M = d.popover) == null ? void 0 : M.progressText) || a("progressText") || "{{current}} of {{total}}")
          .replace("{{current}}", `${s + 1}`)
          .replace("{{total}}", `${c.length}`),
        x = ((R = d.popover) == null ? void 0 : R.showButtons) || a("showButtons"),
        C = ["next", "previous", ...(h ? ["close"] : [])].filter((_e) => !(x != null && x.length) || x.includes(_e)),
        y = ((I = d.popover) == null ? void 0 : I.onNextClick) || a("onNextClick"),
        k = ((ie = d.popover) == null ? void 0 : ie.onPrevClick) || a("onPrevClick"),
        T = ((ne = d.popover) == null ? void 0 : ne.onCloseClick) || a("onCloseClick");
      Q({
        ...d,
        popover: {
          showButtons: C,
    ...
    function v(s = !0) {
      ...
      if (
        ...
        u && u(P ? void 0 : c, d, { config: a(), state: l() }), h && h(P ? void 0 : c, d, { config: a(), state: l() });
      }
      m && m.focus();
    }
    return {
      ...
      highlight: (s) => {
        w(),
          Q({
            ...s,
            popover: s.popover ? { showButtons: [], showProgress: !1, progressText: "", ...s.popover } : void 0,
          });
      },
      destroy: () => {
        v(!1);
  ...
  return (D.driver = ke), Object.defineProperty(D, Symbol.toStringTag, { value: "Module" }), D;
})({});
